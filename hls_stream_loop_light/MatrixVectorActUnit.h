...
#if MVAU_DEBUG
            cout << hex << "    temp_wgt_a:" << ap_uint<SIMD*W_BIT>(temp_wgt_a)  << ", temp_in:" << temp_in;
            cout << hex << ", acc[" << p << "]: " << acc[p] << endl;
            cout << hex << "    temp_wgt_b:" << ap_uint<SIMD*W_BIT>(temp_wgt_b)  << ", temp_in:" << temp_in;
