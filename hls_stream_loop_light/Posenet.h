...
#define POSE_HCV1_SIMD       4
#define POSE_HCV1_LOG2_SIMD  2
#define POSE_HCV1_PE         4
...
#define POSE_DECV1_SIMD       2
#define POSE_DECV1_LOG2_SIMD  1
#define POSE_DECV1_PE         2
...
static block config[BLOCK_NUMS] = {
        { "blk1",  128,96,64,48, 1, 3,1,   2,0,1 },
        { "blk2",  64,48,64,48,  1, 6,1,   1,1,0 },
        { "blk3",  64,48,32,24,  1, 6,1,   2,0,1 },
        { "blk4",  32,24,32,24,  1, 6,1,   1,1,1 },
        { "blk5",  32,24,32,24,  1, 6,1,   1,1,0 },
        { "blk6",  32,24,16,12,  1, 6,2,   2,0,1 },
        { "blk7",  16,12,16,12,  2,12,2,   1,1,1 },
        { "blk8",  16,12,16,12,  2,12,2,   1,1,1 },
        { "blk9",  16,12,16,12,  2,12,2,   1,1,0 },
        { "blk10", 16,12,16,12,  2,12,3,   1,0,1 },
        { "blk11", 16,12,16,12,  3,18,3,   1,1,1 },
        { "blk12", 16,12,16,12,  3,18,3,   1,1,0 },
        { "blk13", 16,12,8,6,    3,18,5,   2,0,1 },
        { "blk14", 8,6,8,6,      5,30,5,   1,1,1 },
        { "blk15", 8,6,8,6,      5,30,5,   1,1,0 },
        { "blk16", 8,6,8,6,      5,30,10,  1,0,0 }
};

static parm parm_size[BLOCK_NUMS] = {
        { "blk1",  0,48,75,           0,6,12,        0,6,12,     },
        { "blk2",  123,219,273,       14,26,38,     14,26,38,   },
        { "blk3",  369,465,519,       40,52,64,     40,52,64,   },
        { "blk4",  615,711,765,       66,78,90,     66,78,90,   },
        { "blk5",  861,957,1011,      92,104,116,   92,104,116, },
        { "blk6",  1107,1203,1257,    118,130,142,  118,130,142 },
        { "blk7",  1449,1833,1941,    146,170,194,  146,170,194 },
        { "blk8",  2325,2709,2817,    198,222,246,  198,222,246 },
        { "blk9",  3201,3585,3693,    250,274,298,  250,274,298 },
        { "blk10", 4077,4461,4569,    302,326,350,  302,326,350 },
        { "blk11", 5145,6009,6171,    356,392,428,  356,392,428 },
        { "blk12", 7035,7899,8061,    434,470,506,  434,470,506 },
        { "blk13", 8925,9789,9951,    512,548,584,  512,548,584 },
        { "blk14", 11391,13791,14061, 594,654,714,  594,654,714 },
        { "blk15", 16461,18861,19131, 724,784,844,  724,784,844 },
        { "blk16", 21531,23931,24201, 854,914,974,  854,914,974 }
};
